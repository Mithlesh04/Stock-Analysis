...
const MYSQL = (func) => {
    const reutersCode = 'RELI.NS', nseCode = 'RELIANCE', bseCode = '500325' ,
      currentYear = new Date().getFullYear()
      
    multiConn.query(`
            MySql querys     (for know all types of query drop me a message)
...
MYSQL((e, r) => {
    ...
    console.log("mysql_error = ", e)

    var snp = new SnapShots(r)
    let MarketCap = snp.MarketCap()
    console.log("MarketCap = ",MarketCap)
    let PriceToEarnings = snp.PriceToEarnings()
    console.log("PriceToEarnings = ",PriceToEarnings)
    let PriceToBook = snp.PriceToBook()
    console.log("PriceToBook = ",PriceToBook)
    let DividendYield = snp.DividendYield()
    console.log('DividendYield = ',DividendYield)
    let FaceValue = snp.FaceValue()
    console.log("FaceValue = ",FaceValue)
    let EPS = snp.EPS()
    console.log("EPS = ",EPS)
    let DebtToEquity = snp.DebtToEquity()
    console.log("DebtToEquity = ",DebtToEquity)
    let PromoterHolding = snp.PromoterHolding()
    console.log("PromoterHolding = ",PromoterHolding)
    let ROE_TTM = snp.ROE_TTM()
    console.log("ROE_TTM = ",ROE_TTM)
    let ROE_3YR = snp.ROE_3YR()
    console.log("ROE_3YR = ",ROE_3YR)
    let ROA_TTM = snp.ROA_TTM()
    console.log("ROA_TTM = ",ROA_TTM)
    let ROA_3YR = snp.ROA_3YR()
    console.log("ROA_3YR = ",ROA_3YR)
    let ROCE_TTM = snp.ROCE_TTM()
    console.log("ROCE_TTM = ",ROCE_TTM)
    let ROCE_3YR = snp.ROCE_3YR()
    console.log("ROCE_3YR = ",ROCE_3YR)
    let CurrentRatio = snp.CurrentRatio()
